...
public interface YggdrasilTypes {
  ...
  IElementType DEFINE_CLASS = new YggdrasilElementType("DEFINE_CLASS");
  ...
  IElementType NUMBER = new YggdrasilElementType("NUMBER");
    IElementType OPERATORS = new YggdrasilElementType("OPERATORS");
  ...
  IElementType KW_MACRO = new YggdrasilTokenType("macro");
    IElementType KW_OPERATORS = new YggdrasilTokenType("KW_Operators");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      if (type == ANNOTATIONS) {
      ...
      } else if (type == DEFINE_CLASS) {
        return new YggdrasilDefineClassNode(node);
        ...
        return new YggdrasilOperatorsNode(node);
      } else if (type == PAIR) {
