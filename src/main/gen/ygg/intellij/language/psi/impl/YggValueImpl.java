...
public class YggValueImpl extends ASTWrapperPsiElement implements YggValue {
  ...
  public PsiElement getBoolean() {
    return findChildByType(YggTypes.BOOLEAN);
  }

  @Override
  @Nullable
  public PsiElement getByte() {
    return findChildByType(YggTypes.BYTE);
  }

  @Override
  @Nullable
  public PsiElement getDecimal() {
    return findChildByType(YggTypes.DECIMAL);
  }

  @Override
  @Nullable
  public PsiElement getInteger() {
    return findChildByType(YggTypes.INTEGER);
  }

  @Override
  @Nullable
  public PsiElement getSign() {
    return findChildByType(YggTypes.SIGN);
  }
