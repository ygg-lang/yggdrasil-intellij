...
import ygg.intellij.language.psi.YggAnnotation;
import ygg.intellij.language.psi.YggAnnotationMark;
import ygg.intellij.language.psi.YggPaired;
import ygg.intellij.language.psi.YggVisitor;

public class YggAnnotationImpl extends ASTWrapperPsiElement implements YggAnnotation {

  public YggAnnotationImpl(@NotNull ASTNode node) {
    super(node);
  }
