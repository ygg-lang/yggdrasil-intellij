...
import ygg.intellij.language.psi.YggBackTop;
import ygg.intellij.language.psi.YggVisitor;

public class YggBackTopImpl extends ASTWrapperPsiElement implements YggBackTop {

  public YggBackTopImpl(@NotNull ASTNode node) {
    super(node);
  }
