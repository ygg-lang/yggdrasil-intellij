...
import ygg.intellij.language.psi.YggValue;
import ygg.intellij.language.psi.YggVisitor;

public class YggPairImpl extends ASTWrapperPsiElement implements YggPair {

  public YggPairImpl(@NotNull ASTNode node) {
    super(node);
  }
