...
import ygg.intellij.language.psi.YggNumberSuffix;
import ygg.intellij.language.psi.YggTypes;
import ygg.intellij.language.psi.YggVisitor;

public class YggNumberSuffixImpl extends ASTWrapperPsiElement implements YggNumberSuffix {

  public YggNumberSuffixImpl(@NotNull ASTNode node) {
    super(node);
  }
