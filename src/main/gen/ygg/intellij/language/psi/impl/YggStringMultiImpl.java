...
import ygg.intellij.language.psi.YggStringMulti;
import ygg.intellij.language.psi.YggVisitor;

public class YggStringMultiImpl extends ASTWrapperPsiElement implements YggStringMulti {

  public YggStringMultiImpl(@NotNull ASTNode node) {
    super(node);
  }
