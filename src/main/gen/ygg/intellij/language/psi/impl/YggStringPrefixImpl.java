...
import ygg.intellij.language.psi.YggStringPrefix;
import ygg.intellij.language.psi.YggTypes;
import ygg.intellij.language.psi.YggVisitor;

public class YggStringPrefixImpl extends ASTWrapperPsiElement implements YggStringPrefix {

  public YggStringPrefixImpl(@NotNull ASTNode node) {
    super(node);
  }
