...
public class YggFunctionStatementNode extends ASTWrapperPsiElement implements YggFunctionStatement {

  public YggFunctionStatementNode(@NotNull ASTNode node) {
    super(node);
  }
