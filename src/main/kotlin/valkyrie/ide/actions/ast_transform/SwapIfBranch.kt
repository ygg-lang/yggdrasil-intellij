...
class SwapIfBranch(element: PsiElement, private val above: Boolean) : LocalQuickFixAndIntentionActionOnPsiElement(element), PriorityAction,
    ...
    override fun getText(): String {
        return yggdrasil.language.YggdrasilBundle.message("action.if_swap_branch.name")
    }

    fun getDescription(): String {
        return yggdrasil.language.YggdrasilBundle.message("action.if_swap_branch.help")
    }
