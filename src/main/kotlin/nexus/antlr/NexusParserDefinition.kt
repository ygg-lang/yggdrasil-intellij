...
class NexusParserDefinition : ParserDefinition {
    ...
    override fun createParser(project: Project): PsiParser {
        return NexusParser(YggdrasilAntlrParser(null))
    }
    ...
    override fun getWhitespaceTokens(): TokenSet {
        return PSIElementTypeFactory.createTokenSet(nexus.language.NexusLanguage, YggdrasilAntlrLexer.WHITE_SPACE)
    }
    ...
    companion object {
        init {
            PSIElementTypeFactory.defineLanguageIElementTypes(
                nexus.language.NexusLanguage, YggdrasilAntlrParser.tokenNames, YggdrasilAntlrParser.ruleNames
            )
        }
    }
}
